...
export default function Sidebar() {
  ...
  const navs = [
    ...
    {id:2, label:'Activate Exams', icon:<RiQuestionAnswerLine/>, ref:'/dashboard/admin/exam'},
  ...
  return (
    <div className="h-screen w-64 bg-white shadow-md">
      ...
      <nav className="p-5 flex flex-col justify-between">
        ...
        <li className={'flex text-red-500 items-center p-4 gap-4 hover:bg-green-50 mt-20'} onClick={handleSignOut}>
